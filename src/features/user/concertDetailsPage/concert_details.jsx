...
const ConcertDetails = () => {
    ...
    const [eventDetails, setEventDetails] = useState({
        ...
        province:"تهران",
        city:"تهران",
        photo:"src/features/user/concertDetailsPage/img.png",
        category:"ارکستر سمفونی",
        organizer_photo:"src/features/user/concertDetailsPage/profile.png",
                ...
                {(screenSize==='medium' || screenSize==="small" || screenSize==="extra small") && 
                    <center>
                        ...
                        <div className="row justify-content-right" style={{width:"780px"}}>
                            ...
                            <div className="event-details-card  py-3 mr-0 ml-2 px-3 mb-2" style={{ height:"fit-content",width:"380px",marginLeft:"10px"}}>
                            <p className="pb-3 ed-message text-right">{eventDateTime.startDay} {eventDateTime.startMonth} {eventDateTime.startYear} ساعت {eventDateTime.startTime} </p>
                                    <h4 className=" pb-3 text-right"> {eventDetails.title} </h4>
                                    <div className="row px-3">
                                        <i class="bi bi-tag-fill icons-style"></i>
