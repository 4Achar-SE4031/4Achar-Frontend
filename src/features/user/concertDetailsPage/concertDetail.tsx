  ...
  useEffect(() => {
    if (eventDetails.starts && eventDetails.ends) {
      ...
      setEventDateTime({
        ...
        startMonth:
          monthDict[moment(eventDetails.starts).locale("fa").jMonth()],
        startTime: moment(stime, "HH:mm:ss")
          .subtract(3, "hours")
          .subtract(30, "minutes")
          .format("HH:mm:ss")
          .substring(0, 5),
    ...
    return (
      <div className="event-details">
        ...
        <div
          ...
          style={{ height: "200px", width: "200px", marginTop: "15%" }}
        >
          <Lottie options={defaultOptions} data-testid="lottie"/>
        </div>
      </div>
    );
  }
      ...
      <div className="event-details">
          ...
          <AdvertisementCard
            ...
            >
              <div className="card-back text-right px-3 py-4">
                <p className="pb-3 message">
                  {eventDetails.day} {eventDetails.startDate[2]}{" "}
                  {eventDetails.startDate[1]} {eventDetails.startDate[0]} ساعت{" "}
                  {eventDetails.startTime[0]}:{eventDetails.startTime[1]}
                </p>
                <h4 className=" pb-3"> {eventDetails.eventName} </h4>
                <div className="row px-3">
                  <i className="bi bi-tag-fill icons-style"></i>
                  <p className="message">
                    {eventDetails.price.toLocaleString()} تومان
                  </p>
                </div>
                <div className="row px-3">
                ...
                <div className="row px-3 pt-4">
                  <img
                    className="mt-1"
                    src="src\features\user\concertDetailsPage\profile.png"
        ...
        <div className="section pb-0" style={{ marginLeft: "42px" }}>
          <div className="row justify-content-center">
            <div
              className="card-3d-wrap-ce"
              style={{ height: "469px", width: "355px", marginTop: "15px" }}
            >
              <div className="card-back text-right px-3 py-4">
                <div className="row px-3">
                  <i className="bi bi-clock  icons-style"></i>
                  <p className="pb-1 message">
                    شروع: {eventDetails.startDay} {eventDetails.startDate[2]}{" "}
                    {eventDetails.startDate[1]} {eventDetails.startDate[0]} ساعت{" "}
                    {eventDetails.startTime[0]}:{eventDetails.startTime[1]}
                  </p>
                </div>
                <div className="row px-3">
                  <i className="bi bi-clock  icons-style"></i>
                  <p className="pb-3 message">
                    پایان: {eventDetails.endDay} {eventDetails.endDate[2]}{" "}
                    {eventDetails.endDate[1]} {eventDetails.endDate[0]} ساعت{" "}
                    {eventDetails.endTime[0]}:{eventDetails.endTime[1]}
                  </p>
                </div>
            ...
            <div>
              <div className="section py-1 mr-0 ml-2 px-0 mb-2 pb-5">
                <div
                  className="card-3d-wrap-description pb-0    mb-0 mx-0 px-0"
                  style={{ height: "470px", width: "85vh" }}
                >
                  <div className="card-back text-right px-3 pt-4  pb-1 mb-1">
                    ...
                    <center>
                      <button
                        ...
                        onClick={() =>
                          window.open(
                            "https://www.iranconcert.com/concert/16472/",
                            "_blank"
                          )
                        }
                      >
