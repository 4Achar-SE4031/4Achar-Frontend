...
const Register: React.FC = () => {
    ...
    const [enteredRegisterUserName, setEnteredRegisterUserName] =
        useState<string>("");
    const [enteredRegisterEmail, setEnteredRegisterEmail] =
        useState<string>("");
    ...
    const registerPasswordHandler2 = (event: ChangeEvent<HTMLInputElement>) => {
        ...
        if (event.target.value !== enteredRegisterPassword) {
            ...
            setRegisterPasswordValidationMsg2(
                "رمزعبور و تکرار آن باید یکسان باشند"
            );
        } else {
            if (event.target.value.length < 8) {
                setRegisterPasswordValidation2(false);
                                            ...
                                            <div className="section text-center">
                                                ...
                                                >
                                                    <input
                                                        ...
                                                        value={
                                                            enteredRegisterUserName
                                                        }
                                                        onChange={
                                                            registerUserNameHandler
                                                        }
                                                    />
                                                ...
                                                >
                                                    <i
                                                        ...
                                                        onClick={
                                                            toggleRegisterPasswordVisibility2
                                                        }
                                                        style={{
                                                            fontSize: "20px",
                                                            position:
                                                    ...
                                                    <input
                                                        ...
                                                        autoComplete="on"
                                                        value={
                                                            enteredRegisterPassword2
                                                        }
                                                        onChange={
                                                            registerPasswordHandler2
                                                        }
                                                    />
                                                    <i className="input-icon uil uil-lock-alt"></i>
                                                </div>
